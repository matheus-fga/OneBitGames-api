...
RSpec.describe "Admin::V1::Categories as :admin", type: :request do
  ...
  context "GET /categories" do
    ...
    context "without any params" do
      it "should return default length" do
        get url, headers: auth_header(user)
        expect(body_json['categories'].count).to eq 10
      end
      
      it "should return first 10 categories" do
        get url, headers: auth_header(user)
    ...
    context "with search[name] param" do
      ...
      it "should return only seached categories limited by default pagination" do
    ...
    context "with order params" do
      ...
      it "should return ordered categories limited by default pagination" do
